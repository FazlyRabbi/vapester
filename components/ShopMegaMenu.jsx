  ...
  return (
    <div className="container mx-auto">
      <div
        ...
        className="flex justify-end items-center lg:hidden mt-4 mr-4"
      >
      ...
      <div
        className={`${
          toggle ? "flex" : "hidden"
        }  lg:justify-end items-center lg:pt-4 pl-8 lg:pl-0  mx-auto  w-[90%] bg-[#1A191E] lg:bg-white py-4`}
      >
      ...
      <div>
        <ul className="hidden lg:flex justify-end mt-4 text-xl space-x-6 font-bum text-black font-bold font-eco">
          <li>
            <a
              href="#"
              className="block py-2 pl-3 pr-4 text-gray-900   hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
