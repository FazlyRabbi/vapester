    ...
    <>
      ...
      >
        <div className="relative w-full h-full">
          <div className="text-center absolute left-[4%] top-[15%]  text-white mx-0 bg-[#D22756] h-36 pr-4">
            <p className="font-black uppercase text-[80px] tracking-widest -mt-7 text-start font-bun">
              {" "}
              Visit our <br />
          ...
          <div className="absolute left-[4%] top-[65%]">
            <div className="flex justify-evenly items-center gap-10">
              <h1 className="text-white text-[80px] font-eco">April 25</h1>
