    ...
    return (
        ...
        >
            <SwiperSlide className="w-full">
                <div className="grid grid-cols-2 bg-purple-600 w-full h-screen mx-0">
                    <div className='text-left px-4 py-8 md:px-7 md:py-12 lg:px-14 lg:py-20'>
                        <p className='text-white font-semibold tracking-widest uppercase text-sm mt-2'>Custom Boxes</p>
                        <p className="text-white font-extrabold text-xl md:text-[32px] lg:text-[40px] mt-6">Customized bulk <br /> Paper bags</p>
            ...
            <SwiperSlide className=" w-full">
            <div className="grid grid-cols-2 bg-second w-full h-screen mx-0">
                    <div className='text-left px-4 py-8 md:px-7 md:py-12 lg:px-14 lg:py-20'>
                        <p className='text-white font-semibold tracking-widest uppercase text-sm mt-2'>Custom Boxes</p>
                        <p className="text-white font-extrabold text-xl md:text-[32px] lg:text-[40px] mt-6">Customized bulk <br /> Paper bags</p>
                        <p className='text-white font-normal mt-6'>Turn your ideas into premium products that <br /> leave a lasting impression </p>
